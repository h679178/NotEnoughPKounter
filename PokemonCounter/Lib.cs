...
namespace PokemonCounter
{
    class Lib
    {
        ...
        public static string[][] GensData =
        {
            new string[] { "GEN 1", "GEN 2", "GEN 3", "GEN 4", "GEN 5", "GEN 6", "GEN 7", "GEN 8", "GEN 9", "Mystery Dungeon"},
            new string[] { "151", "251", "386", "493", "649", "721", "809", "905", "1025", "1025"},
            new string[] { "gen1", "gen2", "gen3", "gen4", "gen5", "gen6+", "gen6+", "gen6+", "gen6+", "gen6+"},
        };
        public static string[][][] GamesList =
        {
                new string[][] {
                    ...
                    new string[] { "X/Y & OR/AS"},
                    new string[] { "US/UM & Let's GO"},
                    new string[] { "Sword/Shield", "Home"},
                    new string[] { "Scarlet/Violet", "Home"},
                    new string[] { "Mystery Dungeon"},
                },
                new string[][] {
                    new string[] { "rb", "yellow"},
                    new string[] { "crystal", "gold", "silver"},
                    new string[] { "emerald", "rs", "frlg"},
                    new string[] { "dp", "platinum", "hgss"},
                }
        };
        ...
        public static void FillHunts(string jsonData, DataGridView DGV_ToFill, bool caught , string dex, string name, string count, bool filtering)
        {
            ...
            for (int i = 0; i < huntsData.Count; i++)
            {
                ...
                if (filtering)
                {
                    if (completed != caught) continue;
                    if (!dexnmb.Contains(dex)) continue;
                    if (!pkmnName.ToLower().Contains(name.ToLower())) continue;
                    if (!encounters.ToString().Contains(count)) continue;
                }
        ...
        {
            string[] result = new string[PkmnNamesList.Length];
