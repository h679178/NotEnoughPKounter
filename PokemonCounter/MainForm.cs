...
namespace PokemonCounter
{
    public partial class MainForm : Form
    {
        ...
        private void DeleteCell()
        {
            ...
            if (TBL_CONTENT.Controls.Count < 1) AddCell();
        }
        ...
        private void OpenProperties(int Actual)
        {
            ...
            try { Pkmn.CB_GEN.SelectedIndex = Lib.HuntsList[Actual].genIndex; }
            catch { Pkmn.CB_GEN.SelectedIndex = Pkmn.CB_GEN.Items.Count-1; }
            try { Pkmn.CB_GAME.SelectedIndex = Lib.HuntsList[Actual].gameIndex; }
            catch { Pkmn.CB_GAME.SelectedIndex = 0; }
            ...
            // FIXING RETROCOMPATIBILITY WITH 1.3 AND OLDER
            if (!Pkmn.CKB_GIF.Enabled) Pkmn.CKB_GIF.Checked = false;
